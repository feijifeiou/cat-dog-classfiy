...
# 项目常用加载数据集方式
# 训练集与测试集的路径
ROOT_TRAIN = 'D:\\pycharm\\Lbw_Cat_Dog\\data\\train'
ROOT_TEST = 'D:\\pycharm\\Lbw_Cat_Dog\\data\\val'
...
# 断点续训 加载以前的权重参数
# model.load_state_dict(torch.load("AlexNet_37_0.85_acc_max.pth"), strict=True)
